...
void add_box( struct matrix * points,
  ...
  z2 = z - depth;
	...
	add_polygon( points, // FRONT BOTTOM
		x, y, z,
		x, y2, z,
		x2, y2, z );
	add_polygon( points, // FRONT TOP
		x, y, z,
		x2, y2, z,
		x2, y, z );
	add_polygon( points, // TOP BOTTOM
		x, y, z,
		x2, y, z,
		x, y, z2 );
	add_polygon( points, // TOP TOP
		x, y, z2,
		x2, y, z,
		x2, y, z2 );
	add_polygon( points, // RIGHT BOTTOM
		x2, y, z,
		x2, y2, z,
		x2, y2, z2 );
	add_polygon( points, // RIGHT TOP
		x2, y2, z2,
		x2, y, z2,
		x2, y, z);

	add_polygon( points, //LEFT TOP
		x, y, z,
		x, y, z2,
		x, y2, z );
	add_polygon( points, // LEFT BOTTOM
		x, y2, z,
		x, y, z2,
		x, y2, z2 );
	add_polygon( points, // BACK TOP
		x, y, z2,
		x2, y, z2,
		x, y2, z2 );
	add_polygon( points, // BACK BOTTOM
		x2, y, z2,
		x2, y2, z2,
		x, y2, z2 );
	add_polygon( points, // BOTTOM BOTTOM
		x2, y2, z2,
		x2, y2, z,
		x, y2, z );
	add_polygon( points, // BOTTOM TOP
		x, y2, z,
		x, y2, z2,
		x2, y2, z2 );
}
